...
if( !class_exists( 'MV_Slider_Settings' ) ){
	class MV_Slider_Settings
	{
		...
		{
			?>
				<input type="texte" name="mv_slider_options[mv_slider_title]" id="mv_slider_title" value="<?= isset(self::$options['mv_slider_title']) ? esc_attr(self::$options['mv_slider_title']) : ''?>">
			<?php
		}
